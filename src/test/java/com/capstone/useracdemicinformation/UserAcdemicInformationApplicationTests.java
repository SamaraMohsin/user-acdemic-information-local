package com.capstone.useracdemicinformation;
...
import com.capstone.useracdemicinformation.Controller.CandidateAcademicInfoController;
import com.capstone.useracdemicinformation.Model.CandidateAcademicInfo;
import com.capstone.useracdemicinformation.Service.CandidateAcademicInfoService;
...
class UserAcdemicInformationApplicationTests {
	...
	public void canUpdateCandidateAcademicInfo() throws Exception {
		CandidateAcademicInfo info = new CandidateAcademicInfo(2L, 65L, "Masters", "AP", "KU", "no", null, "3.4",
				"My cool FYP");
		when(academicInfoService.updateAcademicInformation(2L, info)).thenReturn(info);
